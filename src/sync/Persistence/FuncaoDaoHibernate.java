...
public class FuncaoDaoHibernate implements FuncaoDao{
    ...
    @Override
    public void create(Funcao entity) throws DataBaseException, DuplicateKeyException {
    ...
    @Override
    public void edit(Funcao entity) throws DataBaseException {
        Session sessao = null;
        try{
        sessao = NewHibernateUtil.getSessionFactory().openSession();
        Transaction transacao = sessao.beginTransaction();
    ...
    @Override
    public void delete(Funcao entity) throws DataBaseException {
        Session sessao = null;
        try{
        sessao = NewHibernateUtil.getSessionFactory().openSession();
        Transaction transacao = sessao.beginTransaction();
    ...
    @Override
    public Funcao read(int id) throws DataBaseException {
        Session sessao = null;
        ...
        try{
            ...
            Query query = sessao.createQuery("from Funcao as f Where f.id = "+id+"");
            listaF = query.list();
            if(listaF.size()>0){
                func = listaF.get(0);
            }
    ...
    @Override
    public List<Funcao> read(String query) throws DataBaseException {
        Session sessao = null;
        List<Funcao> listaF = null; 
        try{
            sessao = NewHibernateUtil.getSessionFactory().openSession();
    ...
    @Override
    public List<Funcao> readAll() throws DataBaseException {
        Session sessao = null;
        List<Funcao> listaF = null; 
        try{
            sessao = NewHibernateUtil.getSessionFactory().openSession();
