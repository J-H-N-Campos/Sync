...
public class TelaCadastroProduto extends javax.swing.JFrame
{
    ...
    private final static Logger logger = Logger.getLogger(TelaCadastroProduto.class);
    
    public TelaCadastroProduto()
    {
        initComponents();
        URL url = this.getClass().getResource("../Assets/product.png");
    ...
    private void atualizarTabela()
    {
        this.tabela.setModel(new TableModel()
        {
            ...
            public int getRowCount()
            {
                ...
                try {
                    listaP = DaoFactory.newProdutoDao().read("FROM Produto As p Where p.nome like '%"+campoPesquisar.getText()+"%'");
    ...
    private void limpaCampos()
    {
        campoNome.setText("");
        campoMarca.setText("");
        this.campoValidade.setDate(new Date());
    }

    private boolean validaCampos()
    {
        boolean valido = true;
        if (campoNome.getText().length() == 0 && campoMarca.getText().length() == 0)
        {
            valido = false;
    ...
    private void initComponents() {
        ...
        campoMarca = new javax.swing.JFormattedTextField();
        botaoSalvar = new javax.swing.JButton();
        botaoEditar = new javax.swing.JButton();
        botaoExcluir = new javax.swing.JButton();
        jLabel1 = new javax.swing.JLabel();
        campoValidade = new com.toedter.calendar.JDateChooser();
        ...
        campoValidade.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(campoValidade, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel2Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {campoMarca, campoNome, campoValidade});

        jPanel2Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {jLabel1, rotuloIdioma, rotuloNome});
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(campoValidade, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel1))
                        .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
        );

        jPanel2Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {campoMarca, campoNome, campoValidade});

        jPanel2Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {jLabel1, rotuloIdioma, rotuloNome});
    ...
    private void botaoSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoSalvarActionPerformed
        ...
        produto.setValidade(this.campoValidade.getDate());
        try {
    ...
    private void botaoEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoEditarActionPerformed
        int id = Integer.parseInt(JOptionPane.showInputDialog(null, "Código do produto a ser ALTERADO:", "Editar", JOptionPane.PLAIN_MESSAGE));
        try{
    ...
    private void botaoExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoExcluirActionPerformed
        ...
        int id = Integer.parseInt(JOptionPane.showInputDialog(null, "Código do produto a ser EXCLUÍDO:", "Excluir", JOptionPane.PLAIN_MESSAGE));
        try{
            Produto produto = DaoFactory.newProdutoDao().read(id);
            DaoFactory.newProdutoDao().delete(produto);
    ...
    private javax.swing.JFormattedTextField campoMarca;
    private javax.swing.JFormattedTextField campoNome;
    private javax.swing.JTextField campoPesquisar;
    private com.toedter.calendar.JDateChooser campoValidade;
