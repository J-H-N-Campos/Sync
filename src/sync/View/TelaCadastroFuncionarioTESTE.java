 ...
 * @author joao
 */
public class TelaCadastroFuncionarioTESTE extends javax.swing.JFrame {
    ...
    private final static Logger logger = Logger.getLogger(TelaCadastroFuncionarioTESTE.class);

    public TelaCadastroFuncionarioTESTE() {
        initComponents();
...
//cidades
        try {
            ...
            java.util.logging.Logger.getLogger(TelaCadastroFuncionarioTESTE.class.getName()).log(Level.SEVERE, null, ex);
        }
