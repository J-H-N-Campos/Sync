...
public class TelaCadastroTipoExame extends javax.swing.JFrame
{
    ...
    private void botaoEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoEditarActionPerformed
        int id = Integer.parseInt(JOptionPane.showInputDialog(null, "Código do tipo de exame a ser ALTERADO:", "Editar", JOptionPane.PLAIN_MESSAGE));
        try{
    ...
    private void botaoExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoExcluirActionPerformed
        ...
        int id = Integer.parseInt(JOptionPane.showInputDialog(null, "Código do tipo de exame a ser EXCLUÍDO:", "Excluir", JOptionPane.PLAIN_MESSAGE));
        try{
            TipoExame tipoExame = DaoFactory.newTipoExameDao().read(id);
            DaoFactory.newTipoExameDao().delete(tipoExame);
