...
public class PropertiesForm extends javax.swing.JDialog
{
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(tfDBName, javax.swing.GroupLayout.DEFAULT_SIZE, 143, Short.MAX_VALUE)
    ...
    {//GEN-HEADEREND:event_btnConfirmActionPerformed
        if (!this.getUserName().isEmpty()&& !this.getPassword().isEmpty()&& this.getDBName().isEmpty())
        {
            this.confirm = true;
            dispose();
        }
